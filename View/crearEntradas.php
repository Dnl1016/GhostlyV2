<?php
    ...
    $listarProductos = $controladorEntradas->listarDetalleProductos();
?>
<!DOCTYPE html>
<html lang="en">
...
<body id="page-top">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="../Controller/controladorEntradas.php?listarEntradas" style="height: 50%;" class="btn btn-dark">Regresar</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div id="error"></div>
                            <form action="../Controller/controladorEntradas.php" method="POST">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card border-dark mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="idDetalleProducto">
                                            ...
                                            <div class="card-footer">
                                                <button type="button" class="btn btn-dark col-md-12" id="agregarEntrada"><i class="fas fa-plus"></i></button>
                                            </div>
                                        </div>
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 style="text-align: center; margin-top: 2px;">Detalle entradas</h3>
                                            </div>
                                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input name="registrarEntradas" type="submit" class="btn btn-dark col-md-12" value="Guardar entradas">
                                        <hr>
                                        <a href="../Controller/controladorEntradas.php?listarEntradas" class="btn btn-secondary col-md-12">Cancelar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script src="js/funcionesEntradas.js"></script>
</body>
</html>